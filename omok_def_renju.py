...
def function44(player,x,y):
    if (board[y][x+1] == player and board[y][x+2] == player and board[y][x+3] == player) or \
            (board[y][x+1] == player and board[y][x+2] == player and board[y][x-1] == player) or \
            (board[y][x+1] == player and board[y][x-1] == player and board[y][x-2] == player) or \
            (board[y][x-1] == player and board[y][x-2] == player and board[y][x-3] == player):
        if (board[y+1][x] == player and board[y+2][x] == player and board[y+3][x] == player) or \
                (board[y+1][x] == player and board[y+2][x] == player and board[y-1][x] == player) or \
                (board[y+1][x] == player and board[y-1][x] == player and board[y-2][x] == player) or \
    ...
    if (board[y+1][x] == player and board[y+2][x] == player and board[y+3][x] == player) or \
        ...
        if (board[y][x + 1] == player and board[y][x + 2] == player and board[y][x + 3] == player) or \
                ...
                (board[y][x - 1] == player and board[y][x - 2] == player and board[y][x - 3] == player):
            return False
    if (board[y+1][x+1] == player and board[y+2][x+2] == player and board[y+3][x+3] == player) or \
            (board[y+1][x+1] == player and board[y+2][x+2] == player and board[y-1][x-1] == player) or \
            (board[y+1][x+1] == player and board[y-1][x-1] == player and board[y-2][x-2] == player) or \
